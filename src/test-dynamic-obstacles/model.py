...
class GridWorldModel:
    def __init__(
        ...
        # Initialize features as empty lists/sets
        self.start_states: List[Tuple[int, int]] = []
        self.goal_states: List[Tuple[int, int]] = []
        ...
        self._set_features(start_states, goal_states, obstacles)
    ...
    def _set_features(
        ...
        """Internal method to set and validate grid features."""
        ...
        if goal_states is None:
            self.goal_states = [(self.rows - 1, self.cols - 1)]
        else:
